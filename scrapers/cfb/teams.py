from builtins import range, list, set, len, int, open, str, filter, map, bool
...
def compile_rankings(final):
    listed_teams = get_listed_teams(final)
...
def scrape(start_week, end_week, start_year):
